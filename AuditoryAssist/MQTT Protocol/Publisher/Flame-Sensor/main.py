# shz flame sensor - final stable for SR-01C test (1-second publish)
...
# SR 표를 기존 가스/MQ7처럼 채우기 쉽게 1초 heartbeat 유지
HEARTBEAT_MS         = 1_000
...
# SR 측정 중에는 status heartbeat는 꺼두는 것이 안전
ENABLE_STATUS_HEARTBEAT = False

# 누적 publish로 transport 꼬이는 것 방지
