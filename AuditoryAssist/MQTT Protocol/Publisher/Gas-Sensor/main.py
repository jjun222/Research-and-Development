...
# Gas sensor stays on 10-second publish to reduce transport load
HEARTBEAT_MS = 5_000
...
# Product mode: keep quiet unless debugging
DEBUG_PUBLISH = False
ENABLE_STATUS_HEARTBEAT = False

# Avoid too-frequent forced reconnects
