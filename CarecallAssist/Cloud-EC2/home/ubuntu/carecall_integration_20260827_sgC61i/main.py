...
ENABLE_DEV_ENDPOINTS = os.getenv(
    "CARECALL_ENABLE_DEV_ENDPOINTS",
    "false",
...
def schedule_event_notification(
    *,
    ...
    try:
        active_tokens = list_active_fcm_tokens(db, user_id=user_id)
    ...
    def create_test_help_request(db: Session = Depends(get_db)):
        ...
        save_latest_status(
            db,
            {
                ...
                "last_impact_at": previous_status.get("last_impact_at"),
                "updated_at": occurred_at,
                "camera_stream_url": previous_status.get(
                    "camera_stream_url",
                    "",
                ),
                "snapshot_url": previous_status.get("snapshot_url", ""),
